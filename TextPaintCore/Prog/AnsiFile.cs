...
namespace TextPaint
{
    public class AnsiFile
    {
        ...
        public List<int> Process(AnsiLineOccupyEx TextBuffer, int TextBufferI, bool LinePrefix, bool LinePostfix, int AnsiMaxX, int[] CharDbl, int[] CharDblInv)
        {
            ...
            for (int ii = 0; ii < TextBuffer.CountItems(TextBufferI); ii++)
            {
                ...
                if (CharDblInv[TextBuffer.Item_Char] == 0)
                {
                    // Font size change
                    ...
                    if (ii < AnsiMaxX)
                    {
                        ...
                        LastFontW = CoreStatic.FontCounter(LastFontW);
                    }
                }
            }
