...
namespace TextPaint
{
    public partial class Core
    {
        ...
        public bool AnsiTerminalResize(int NewW, int NewH)
        {
            ...
            if ((__AnsiScrollFirst == 0) && (__AnsiScrollLast == (AnsiMaxY - 1)))
            {
                __AnsiScrollLast = (NewH - 1);
            }
            if ((__AnsiMarginLeft == 0) && (__AnsiMarginRight == (AnsiMaxX - 1)))
            {
                __AnsiMarginRight = (NewW - 1);
            }
        ...
        public int AnsiProcess(int ProcessCount)
        {
            ...
            while (ProcessCount > 0)
            {
                ...
                if (StdProc)
                {
                    ...
                    if (__AnsiCommand)
                    {
                        ...
                        if (__AnsiCmd.Count > 0)
                        {
                            ...
                            else
                            {
                                ...
                                if (__AnsiCommand && (__AnsiCmd[0] != ']') && (__AnsiCmd.Count >= 2) && (CommandEndChar.Contains(AnsiBuffer[AnsiBufferI])))
                                {
                                    __AnsiCommand = false;
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if (__AnsiDCS_)
                            {
                                __AnsiDCS = __AnsiDCS + TextWork.IntToStr(AnsiBuffer[AnsiBufferI]);
                            }
                            else
                            {
                                AnsiCharPrint(AnsiBuffer[AnsiBufferI]);
                ...
                {
                    if (ProcAdditionalChars && (__AnsiAdditionalChars < ANSIScrollBuffer))
                    {
                        __AnsiAdditionalChars++;
                    }
                    ProcessCount--;
        ...
        public void AnsiCharF(int X, int Y, int Ch, int ColB, int ColF)
        {
            ...
            else
            {
                ...
                __AnsiFontSizeW = FontCounter(__AnsiFontSizeW);
            }
        }
