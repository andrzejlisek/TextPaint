        ...
        public void Init(string CurrentFileName_, string[] CmdArgs)
        {
            ...
            if (WorkMode != 4)
            {
                if (UseWindow)
                {
                    ...
                    Screen_ = new ScreenWindowWinForms(this, CF.ParamGetI("WinFixed"), CF, WinW__, WinH__, ColorBlending, ColorBlendingConfig, false);
            ...
            {
                Screen_ = new ScreenWindowWinForms(this, 0, CF, 1, 1, ColorBlending, ColorBlendingConfig, true);
